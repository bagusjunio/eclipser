...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    if (user) {
      ...
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.public)).setURL("https://discord.com/api/oauth2/authorize?client_id=907864434309992449&permissions=8&scope=bot")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(`${user.username} | powered by Bagusjunio.dev`, "https://cdn.discordapp.com/attachments/923223701019848704/923240151889621002/4908d64a0e91fb7e3b8cadd53100267c.png")
        ],
