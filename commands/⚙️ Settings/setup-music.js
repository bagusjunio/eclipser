...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    var embeds = [
      new MessageEmbed()
      .setColor(es.color)
      .setTitle(`<a:e1:935384731187556372> Queue of __${message.guild.name}__`)
      ...
      .setImage(`https://media.discordapp.net/attachments/929932299179528233/930292569575948448/play_music.png?width=1214&height=683`)
