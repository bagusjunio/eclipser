...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite Public Bot').setURL("https://discord.com/oauth2/authorize?client_id=923203259651461161&permissions=8&scope=bot")
      ...
      interaction.reply({ephemeral: true, 
        embeds: [new MessageEmbed()
          ...
          .setFooter(client.user.username  + ' | powered by Bagus Junio.dev', 'https://media.discordapp.net/attachments/923223701019848704/923240151889621002/4908d64a0e91fb7e3b8cadd53100267c.png')
          .setURL("https://discord.com/oauth2/authorize?client_id=923203259651461161&permissions=8&scope=bot")],
